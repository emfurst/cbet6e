...
- `ch12/solid_solubility_naphthalene_hexane_example.ipynb` — How much solid dissolves, and what the activity coefficient is worth (naphthalene / n-hexane)
...
- `ch13/titration_strong_and_weak_acids_example.ipynb` — Two titration curves, and why only one of them is interesting
