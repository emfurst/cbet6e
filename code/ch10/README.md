...
**None of the fourteen has been pasted into `c10.docx` yet** — the placeholder tracker
...
Run the generator **with segno** or it reports success and silently stages the old
...
**Figure d is drawn as a T-x-y and the 5e caption calls it a P-x-y.** The caption is
